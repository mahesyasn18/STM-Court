...
import com.example.stmcourt.BuildConfig
import com.example.stmcourt.StmCourt
import com.example.stmcourt.utils.Helpers
...
class HttpClient {
    ...
    private fun buildRetrofitClient(){
        val token = StmCourt.getApp().getToken()
    ...
    fun buildRetrofitClient(token : String?){
        ...
        if (BuildConfig.DEBUG){
            ...
            builder.addInterceptor(ChuckInterceptor(StmCourt.getApp()))
        }
